...
from open_arangodb.models import ChangeEvent, ChangeOp, Memory
...
class CDCEngine:
    ...
    approach: all writes go through ArangoDB.insert/update/delete which call
    ...
    service layer (which the ArangoDB gateway enforces).
    """

    CHANGELOG = "_arangodb_changelog"
    CHECKPOINTS = "_arangodb_checkpoints"

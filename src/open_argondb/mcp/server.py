"""Open ArgonDB MCP server -- exposes memory operations to Claude Code."""
...
class ArgonDBMCPServer:
    """MCP server exposing Open ArgonDB tools.

    Wraps an ArgonDB instance and exposes tools for:
    ...
    def _handle_retrieval_search(self, args: dict[str, Any]) -> dict[str, Any]:
        # Use retrieval orchestrator if available on the ArgonDB instance
